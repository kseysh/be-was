...
-- 3. Article 데이터 생성
INSERT INTO article (article_id, content, user_id, image_id, like_count)
VALUES ('art-001',  '안녕하세요, 테스트유저입니다.', 'ti', 'article-img-id-1', 1),
       ('art-002',  '철수의 게시글입니다.', 'user2', 'article-img-id-2', 2),
       ('art-003',  '영희가 쓴 글입니다.', 'user3', 'article-img-id-3', 3),
       ('art-004',  '지성이 쓴 글입니다.', 'user4', 'article-img-id-4', 4),
       ('art-005',  '흥민이 쓴 글입니다.', 'user5', 'article-img-id-5', 5);
